...
urlpatterns = [
    ...
    path('department/course/year', views.year_courses, name='create_course'),
    path('<int:department>/<int:course>/<int:year>/<int:semester>', views.semester_courses, name='create_course'),
]