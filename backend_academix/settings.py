"""
Django settings for backend_academix project.
...
SECRET_KEY = 'django-insecure-ilj-v=f-n!g!4wbz92y0ax86(8i6dc=#0e2ahw!)3wv_ql@u*%'
...
WSGI_APPLICATION = 'backend_academix.wsgi.application'
